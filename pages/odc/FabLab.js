...
import { chatbotFlowResultsFabLab } from "../../shared/helpers/helpers";
...
export default function Home({country}) {
  ...
  useEffect(() => {
    chatbotFlowResultsFabLab().then((res) => {
      setChatbotFlow([
        {
          id: "0",
          message:
  ...
  function do_VidZoom() {
    ...
    var frames_VidZoom_In = [
      ...
      {
        transform: "scale(1.4, 1.4) translate(-20%,-10%)",
    ...
    <div>
      <div id="wrap">
        <div id="inner">
          ...
          <div id="chat" className="keypoint-chat-fablab">
            <img
              src="/images/chat.png"
          ...
          {showModal && (
            <Chat
              steps={chatbotFlow}
              botAvatar={"../images/FabLabResp.png"}
              headerTitle={<div className="ChatTitle">Responsable Fab Lab {country}</div>}
              onClose={decrease}
            />
          )}
          ...
          <video
            ...
            loop="loop"
            muted
            src="../videos/FablabSolidaire7.mp4"
          ></video>
        </div>
      </div>
